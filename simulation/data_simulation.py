...
num_radii = 20
num_vaccine_levels = 20
num_fatality_thresholds = 20
...
populations = np.empty((iterations,4,samples,num_radii, num_vaccine_levels,
        ...
        for (t, threshold) in enumerate(fatality_thresholds):
            ...
            for sim in range(samples):
                ...
                for i in range(iterations):
                    ...
                    populations[i,:,sim,r,rem,t] = np.array([num_infectives, num_removes, num_susceptibles,
